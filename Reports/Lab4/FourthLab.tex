...
На \hyperref[Test1]{рисунке 4} представлен график зависимости времени работы алгоритмов и количества потоков.
\begin{figure}[h!]
	\centering
...
\end{figure}
\clearpage
На \hyperref[Test2]{рисунке 5} представлен график зависимости времени работы алгоритмов и размера матриц.
\begin{figure}[h!]
	\centering
	\begin{tikzpicture}[object/.style={thin,double,<->}]
